...
public class FragmentoComidas extends Fragment {
    ...
    private void poblarViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(FragmentComida.newInstance(0), "Comida Rapida");
        adapter.addFragment(FragmentComida.newInstance(1), "Cafeteria");
